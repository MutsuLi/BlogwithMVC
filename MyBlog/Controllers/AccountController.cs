...
namespace Netnr.Web.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        /// <returns></returns>
        private ActionResultVM RegisterUser(UserInfo mo)
        {
            var vm = new ActionResultVM();
        ...
        public IActionResult Auth()
        {
            ...
            var url = UserAuthAid.ThirdLogin.LoginLink(authType);
            return Redirect(url);
        }
        ...
        public void SetAuth(HttpContext context, UserInfo user, bool isremember = true)
        {
